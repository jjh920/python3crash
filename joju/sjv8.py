import sys
from joju.SungJuk import SungJuk
from joju.SungJukService import SungJukService
from joju.SungJukDAO import SungJukDAO
...
def showone_sungjuk():
    ...
    print(f'{row[0]} {row[1]} {row[2]} {row[3]} {row[4]} '
          f'{row[5]} {row[6]} {row[7]} {str(row[8])[:10]}')
