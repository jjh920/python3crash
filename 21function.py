...
print(f'{notebookSize2():.4f} inch')
print(f'{notebookSize2():.4f} 인치')
...
op2 = input(
    '연산자를 선택하세요. 1.덧셈 2.뺄셈 3.곱셈 4.나눗셈')
...
mat = int(input('연산자를 선택하세요. 1.덧셈, 2.뺄셈, 3.곱셈, 4.나눗셈'))      #여기는 굳이 int 가 들어갈 필요가 없다.
num2 = int(input('숫자를 입력하세요.'))

                                         #result 값을 초기화 해야된다. result = 0
if mat == '1':
    result = num1 + num2
if mat == '2':                                      # 코드가 비효율적이라 if 다음에 elif로 넣어주어야 한다.
    result = num1 - num2
if mat == '3':
    result = num1 * num2
if mat == '4':
...
# 함수의 값 전달하기
# 매개변수parameter : 함수 정의시 함수에서 사용ㅇ할 변수 정의
