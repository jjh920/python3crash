...
# 산술식 : 산술연산자(+,-,*,/)를 이용한 수식
# 파이썬에서는 //,%, ** 도 지원
print(10 / 3, 10 % 3, 10 // 3) # 나누기(일반적인 나누기), 나머지(나눈 이후 나머지), 몫(나머지 빼고 나눈 정수)
print(10 ** 1, 10 ** 2, 10 ** 3) #지수연산(10의 1승, 10의 2승, 10의 3승)

# 관계식 : 관계 연산자(대소, 순서관계)를 이용한 수식
# 수식의 결과는 True, False 로 출력
print(10 > 3,10 <= 3, 10 == 3)

# 논리식 : 논리연산자(논리 합/곱/부정)를 이용한 수식
# 또한, 둘 이상의 논리식이나 관계식으로 구성된 수식
# 논리식의 경우, 수식의 구성에 따라 단축식 평가short-circuit가 가능
print(( 5 == 3) and (5 > 3))        #and
print((5 != 3) or (5 > 3))          #or
