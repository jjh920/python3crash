# 반복문
# 특정 문장/코드를 지정한 횟수/조건에 의해 반복 실행하는 명령문
...
for i in range(1, 5+1):            #바깥쪽은 행(작은바늘)
    for j in range(1, 5+1):        #안쪽은 열(큰바늘)
        print('*',end='')
    print()                        #줄바꿈(새로운 행 만듦)
...
for i in range(len(employees)):
    print(f'{emails[i]} {fnames[i]} {lnames[i]}'
