...
from hangleUtll import preFormat
...
fun1()
print(num2)         # fun1함수내에 선언된 지역변수 출력 (오류발생!)
print(num3)         # fun1함수내에 선언된 global 지역변수 출력 (정상출력!)
...
num2 = 'abc'
def func2():
    global num2     # 전역변수를 함수 내에서 global로 선언
    num1 = 77
